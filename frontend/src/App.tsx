        ...
        {identity ? (
          <div className="space-y-8">
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              <h2 className="text-xl font-semibold mb-4 text-purple-300">Collection Management</h2>
              <CollectionClaim />
            </div>

            {/* Minting Section */}
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              <h2 className="text-xl font-semibold mb-4 text-purple-300">Mint NFT</h2>
              <MintNFT />
            </div>

            {/* Owned NFTs */}
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              <h2 className="text-xl font-semibold mb-4 text-purple-300">Your NFTs</h2>
              <OwnedNFTs />
            </div>
          </div>
        ) : (
          <div className="text-center py-16">
            <div className="bg-gray-800 rounded-lg p-8 max-w-md mx-auto border border-gray-700">
              <h2 className="text-2xl font-semibold mb-4">Welcome to NFT Collection Manager</h2>
